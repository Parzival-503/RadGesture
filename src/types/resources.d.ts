...
export default interface Resources {
  "translation": {
    "achievements": {
      ...
      "sponsors-viewed": {
        "description": "Consider becoming a sponsor of RadGesture.",
        "name": "Guardian of RadGesture"
      },
      "tier": {
        "I": "I",
        "II": "II",
      ...
      "tutorial-viewed": {
        "description": "Complete the RadGesture introduction tutorial.",
        "name": "The Journey Begins"
      }
    },
    "backends": {
      "gnome": {
        "error": "Could not connect to RadGesture Integration GNOME Shell extension. You can get it from here: {{link}}"
      },
      "hyprland": {
        "shortcut-info": "RadGesture cannot directly bind global shortcuts on Hyprland. Instead, specify a shortcut ID here and bind a shortcut in your hyprland.conf with something like \"bind = CTRL, Space, global, kando:example-menu\". Replace example-menu with the ID chosen here."
      },
      "kde-wayland": {
        "shortcut-info": "RadGesture cannot directly bind global shortcuts on KDE/Wayland. Instead, specify a shortcut ID here and then search for it in the KWin section of the global shortcuts in your KDE's system settings. There you can assign the shortcut which will open this menu."
      },
      "niri": {
    ...
    "example-menu": {
      ...
      "web-links": {
        "google": "Google",
        "kando-on-discord": "RadGesture on Discord",
        "kando-on-github": "RadGesture on GitHub",
        "kando-on-kofi": "RadGesture on Ko-fi",
        "kando-on-youtube": "RadGesture on YouTube",
        "submenu": "Web Links"
      },
      "windows": {
    ...
    "main": {
      ...
      "new-version-notification-header": "A new version of RadGesture is available!",
      "quit": "Quit",
    ...
    "menu-items": {
      "command": {
        ...
        "detached-info": "This will disconnect the command from RadGesture, so it will continue to run even if RadGesture is closed. Disabling this may resolve issues with commands that do not start properly.",
        "isolated": "Run isolated",
        "isolated-info": "This will run the command in a clean environment, meaning that it will not inherit any environment variables from RadGesture. This can help with commands that do not start properly.",
        "name": "Run Command",
      ...
      "common": {
        ...
        "inhibit-shortcuts-info": "Disables all RadGesture shortcuts while the hotkey or macro is being simulated. This prevents the simulated input from accidentally triggering other menu shortcuts."
      },
      "file": {
      ...
      "macro": {
        ...
        "tip-1": "Per default, RadGesture adds a 10ms delay before each key event. You can change this with the \"delay\" property.",
      ...
      "settings": {
        "description": "Opens the RadGesture settings window.",
        "name": "Open Settings",
        "tip-1": "This item type opens the RadGesture settings window."
      },
      "submenu": {
    ...
    "settings": {
      "about-dialog": {
        ...
        "kando-backend": "RadGesture Backend",
        "kando-version": "RadGesture Version",
        "message": "I am creating RadGesture out of sheer passion. If you enjoy using it as much as I love creating it, you can [buy me a coffee]({{link}})!\n\n💖 Simon",
        "read-release-notes": "Read release notes",
        "title": "About RadGesture"
      },
      "achievements-dialog": {
      ...
      "app-picker": {
        "hint": "You can also drag and drop an app from your start menu to RadGesture's menu editor!",
      ...
      "general-settings-dialog": {
        ...
        "backup-settings-note": "This will backup or restore RadGesture's settings, which include all your general settings and your menu-theme configuration.",
        "black": "Black",
        ...
        "check-for-new-versions-info": "If enabled, RadGesture will show a notification when a new version is available.",
        "close-menu": "Close menu",
        "color": "Color",
        "cycle-from-first": "Show next menu (begin at first)",
        "cycle-from-recent": "Show next menu (continue from last)",
        "dark": "Dark",
        "dev-tools-note": "RadGesture uses two windows: One for the menu and one for the settings. You can open the development tools to inspect both windows separately.",
        ...
        "enable-achievements-info": "If enabled, RadGesture will track your progress towards achievements.",
        ...
        "hardware-acceleration-info": "This option can boost the performance of the app, but can also lead to some rendering artifacts. You have to restart RadGesture to apply this setting.",
        "hidden": "Hidden",
        ...
        "lazy-initialization-info": "If enabled, the menu window will only be created when the menu is opened for the first time. This will make the first opening of the menu a bit slower, but it may prevent issues when RadGesture is started too soon during login. Default is disabled.",
        "learn-how-to-add-sound-themes": "Learn how to add new sound themes to RadGesture [here]({{link}})!",
        "learn-interaction-mode": "Learn more about RadGesture's interaction modes [here]({{link}})!",
        "light": "Light",
        "localization-info": "Restart RadGesture to apply the new language.",
        ...
        "message": "All your menus and RadGesture's settings are stored in two JSON files which you can also edit, share, or backup. Click [here]({{link}}) to open the directory where the files are stored.",
      ...
      "import-menu-error-message": "The selected file could not be imported. It does not contain a valid RadGesture exported menu.",
      ...
      "introduction-dialog": {
        ...
        "slide1-text": "Swipe through these slides to learn what RadGesture can do for you! You can use the chapter marks on the left to quickly jump to a specific part of the introduction.",
        "slide1-title": "RadGesture offers a unique and efficient way for interacting with your computer.",
        ...
        "slide12-text": "RadGesture is highly customizable. You can use it to open applications, files, execute keyboard macros, and many other things. You can [change the menu style]({{link1}}), [add icon themes]({{link2}}) and even [use sounds]({{link3}}) in your menus!",
        ...
        "slide2-text-no-shortcuts": "If you launched RadGesture for the first time, you [may need to perform some additional steps on Linux to get the global hotkeys working]({{link}}). Once this is working, you can close a menu with the Escape key or with your right mouse button.",
        "slide2-text-standard": "If you launched RadGesture for the first time, you can open the example menu with Ctrl+Space. Close it again with the Escape key or with your right mouse button anywhere on the screen.",
        ...
        "slide3-text": "In RadGesture, **your entire screen is a click-target**! You do not have to aim for the icons, you can click anywhere in an item's wedge. This makes it much more efficient to select items.",
        ...
        "title": "Welcome to RadGesture!"
      },
      "invalid-dropdown-selection": "Select an option…",
      "menu-behavior": "Menu Behavior",
      "menu-behavior-info": "Before you enable these options, we recommend learning why we like RadGesture's default behavior [here]({{link}})!",
