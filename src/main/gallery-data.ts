        ...
        cards: [
          {
            ...
            text: 'Point-based; sum the 5 categories.\n\nComposition (0–2) · Echogenicity (0–3) · Shape taller-than-wide (0 or 3) · Margin (0–3) · Echogenic foci (additive; punctate +3)\n\nTR1 0 pts (benign) · TR2 2 (not suspicious) · TR3 3 (mild) · TR4 4–6 (moderate) · TR5 ≥7 (high)\n\nFNA: TR5 ≥1 cm · TR4 ≥1.5 cm · TR3 ≥2.5 cm (US-follow smaller TR3–5).',
            source: 'Radiology Assistant',
        ...
        cards: [
          {
            ...
            text: 'Standardises early-pregnancy US terms (Radiology / AJOG 2024).\n\n"Early pregnancy loss (EPL)" replaces "pregnancy failure / nonviable."\nPregnancy of unknown location (PUL) = no definite or probable IUP or ectopic on TVUS.\n\nDefinite EPL: CRL ≥7 mm with no heartbeat, or mean sac diameter ≥25 mm with no embryo. Discourages "pseudosac" and "pregnancy of unknown viability."',
            source: 'Radiology',
